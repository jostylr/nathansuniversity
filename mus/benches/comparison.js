...
var compile5 = (function () {
  ...
  var note_to_midi_mapper = function (pitch) {
    var midi; 
    var letter = pitch[0].toLowerCase();
    var num = pitch[1];
  ...
  //require('./note_mapping.js').note_to_midi_mapper;
...
suite
  ...
  .add('totally non-recurse, ebb', function () { //https://github.com/davidk01/NathansUniversityStuff/tree/master/mus_compiler 
    compile6(longMusWide)
...
suite
  ...
  .add('mostly non-recurse, ebb', function () { //https://github.com/ebb/nathanu/blob/master/hw2/mus.html
...
console.log(compile6(simple))
console.log(compile6(repeat))
console.log(compile6(melody_mus))
